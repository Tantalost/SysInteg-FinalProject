        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-col md:flex-row items-start md:items-center gap-2'>
                <h1 className='text-3xl md:text-4xl font-playfair'>
                    {room.property.name} <span className='font-inter text-sm'>({room.roomType})</span></h1>
            ...
            <div className='flex flex-col md:flex-row md:justify-between mt-10'>
                    <div className='flex flex-col'>
                        <h1 className='text-3xl md:text-4xl font-playfair'>Experience Entertainment 
                    ...
                    {/* Room Price */}
                    <p className='text-2xl font-medium'>₱{room.pricePerNight}/hour</p>
            </div>
            ...
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                ...
                md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        <label htmlFor="Duration" className='font-medium'>Duration
                        </label>
                        <input type="number" id='Duration' placeholder='Duration'
                        className='max-w-30 rounded border border-grey-300 px-3 py-2 mt-1.5 outline-none'/>
                    </div>
                    <div className='w-px h-15 bg-gray-300/70 max-md:hidden'></div>
                    <div className='flex flex-col'>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque aspernatur ab reprehenderit laboriosam dignissimos sint vel. Vel aperiam praesentium fuga quam rem unde minus, placeat minima, quia velit eum eius!</p>
            </div>
