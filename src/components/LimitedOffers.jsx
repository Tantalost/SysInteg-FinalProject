...
import { assets, limitedOffers } from '../assets/assets.js'

const LimitedOffers = () => {
    return (
        <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
            <div className='flex flex-col md:flex-row items-center justify-between w-full'>
                <Title align='left' title='Limited-Time Offers' subTitle='Adventure begins the moment you walk in — don’t miss this limited-time offer.' />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 w-full h-full'>
